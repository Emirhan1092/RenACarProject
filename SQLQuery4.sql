...
(1, 1, 1, '2024-02-27', '2024-03-05'), -- Adjust the ReturnDate value accordingly
(2, 3, 2, '2024-02-27', NULL),
(3, 5, 2, '2024-02-27', NULL),
(4, 4, 1, '2024-02-15', NULL); -- Adjust the ReturnDate value accordingly
...
INSERT INTO CarImages (Id, CarId, ImagePath, ImageDate) VALUES
(1, 1, '/path/to/image1.jpg', '2024-04-01 10:00:00'),
(2, 2, '/path/to/image2.jpg', '2024-04-01 11:00:00');
